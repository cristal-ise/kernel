...
public interface CristalMarshaller {

    /**
     * Marshalls a mapped object to xml string. The mapping must be loaded before.
     *
    ...
    /**
     * Marshalls a mapped object to json string. The mapping must be loaded before.
     *
     * @param obj the object to be marshalled
     * @return the json string of the marshalled object
     */
    public String marshallToJson(Object obj) throws PersistencyException;

    /**
     * Unmarshalls a mapped object from XML string. The mapping must be loaded before.
     *
